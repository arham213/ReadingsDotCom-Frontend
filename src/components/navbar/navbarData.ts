export interface TopRowItem {
  ...
  export const NAVBAR_ITEMS: MainCategory[] = [
    ...
    { code: 2, title: "Fiction", groups: [] },
    { code: 3, title: "Non-Fiction", groups: [] },
    { code: 4, title: "Young Adults", groups: [] },
    { code: 5, title: "Children", groups: [] },
    { code: 6, title: "Urdu Books", groups: [] },
    { code: 7, title: "Our Publications", groups: [] },
    { code: 8, title: "High Discounts", groups: [] },
    { code: 9, title: "Stationery & Art Supplies", groups: [] },
    { code: 10, title: "Toys & Games", groups: [] },
    { code: 11, title: "Send Gift Card", groups: [] },
  ];